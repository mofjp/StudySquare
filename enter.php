...
<html>
<head>
<link rel="stylesheet" href="./stylesheet/enter_style.css">
<meta charset='utf-8'>
<title>Stopwatch</title>
<script src="https://kit.fontawesome.com/834c03dcb0.js" crossorigin="anonymous"></script>
</head>
<body>
  <h1 class="h1a">入室方法を選んでください</h1>
  <div class="select">
   <button onclick="location.href='stopwatch.php'"><i class="fa-solid fa-stopwatch"></i><br><p>ストップウォッチ</p></button>
   <button onclick="location.href='timer.php'"><i class="fa-solid fa-clock"></i><br><p>タイマー</p></button>
  </div>
<!--
  <div id="hoge" class="box">
    <h1>利用規約</h1>
...
-->
  ...
  <p class="warning">※ブラウザバックはご遠慮ください。<br> &emsp;退室をする際には「退室」ボタンを押してください。</p>
<script>
